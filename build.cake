...
Task("Install")
    ...
    .Does(() => {
        ...
        PS.StartProcess($"dotnet tool install  -g {info.PackageId} --add-source https://dotnet.myget.org/F/system-commandline/api/v3/index.json  --add-source {currentDir}/{publishDir} --version {info.Version}");
    });
